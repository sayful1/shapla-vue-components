<template>
    <div id="app" class="shapla-vue-components--demo">
        <div class="shapla-layout__header">
            ...
            <div class="shapla-layout-title">Dashboard</div>
        ...
        <side-navigation :active="activateSideNav" @close="activateSideNav = false" position="left">
            ...
            <div class="sidenav-menu">
                <ul class="sidenav-list">
                    <li class="sidenav-list__item" v-for="menuItem in menuItems">
...
<script>
    import sideNavigation from "../../shapla-side-navigation/src/sideNavigation";
